  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">View Tags</h3>
        <a class="btn btn-success" style="margin-left: 300px;" href="{{ route('tag.create') }}">Add New</a>
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <td>{{ $tag->name }}</td>
                <td>{{ $tag->slug }}</td>
                <td><a href="{{ route('tag.edit',$tag->id) }}"><span class="fas fa-edit" aria-hidden="true" title="Edit"></span></a></td>
                <td>
