  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <a class="btn btn-success" style="margin-left: 300px;" href="{{ route('post.create') }}">Add New</a>
      ...
      <div class="card-body">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">DataTable with Posts</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <td><a href="{{ route('post.edit',$post->id) }}"><span class="fas fa-edit" aria-hidden="true" title="Edit"></span></a></td>
                <td>
