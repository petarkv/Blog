  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <a class="btn btn-success" style="margin-left: 300px;" href="{{ route('permission.create') }}">Add New</a>
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <td><a href="{{ route('permission.edit',$permission->id) }}"><span class="fas fa-edit" aria-hidden="true" title="Edit"></span></a></td>
                <td>
